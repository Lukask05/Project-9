...
def draw_scene(t):
    ...
    #Grass
    jump_to(t,-400,-200)
    draw_rectangle(t,900,140,"green")

    #Lake
    jump_to(t,50,-200)
    draw_rectangle(t,400,140,"steelblue")

    #House
    jump_to(t, -300, -50)
    draw_square(t,150, "white")
    
    #Roof
    jump_to(t, -310, -50)
    draw_triangle(t, 180, "red")
      
    #Door
    jump_to(t, -235, -130)
    draw_rectangle(t, 50, 70, "brown")
    
    #Window
    jump_to(t, -285, -90)
    draw_square(t, 45, "lightblue")
